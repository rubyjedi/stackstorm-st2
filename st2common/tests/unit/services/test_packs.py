...
class DeleteActionFilesTest(TestCase):
...
class DeleteActionEntryPointFilesErrorTest(TestCase):
    """
...
class DeleteActionMetadataFilesErrorTest(TestCase):
    """
...
class CloneActionDBAndFilesTestCase(TestCase):
    @classmethod
    def setUpClass(cls):
...
class CloneActionFilesBackupTestCase(TestCase):
    @classmethod
    def tearDownClass(cls):
        action_files_path = os.path.join(TEST_DEST_PACK_PATH, "actions")
        workflow_files_path = os.path.join(action_files_path, "workflows")
