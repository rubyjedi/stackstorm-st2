...
class TestBaseMetricsDriver(TestCase):
    _driver = None
...
class TestStatsDMetricsDriver(TestCase):
    _driver = None
...
class TestCounterContextManager(TestCase):
...
class TestCounterWithTimerContextManager(TestCase):
    def setUp(self):
...
class TestCounterWithTimerDecorator(TestCase):
    @patch("st2common.metrics.base.get_datetime_utc_now")
    @patch("st2common.metrics.base.METRICS")
    def test_time(self, metrics_patch, datetime_patch):
        start_time = get_datetime_utc_now()
...
class TestCounterDecorator(TestCase):
    @patch("st2common.metrics.base.METRICS")
    def test_counter(self, metrics_patch):
        test_key = "test_key"
